...
console.log("Car " + lastCar.id + " is a " + lastCar.car_make + " " + lastCar.car_model);
...
const oldCars = carYears.filter(car => car < 2000);
console.log(oldCars);

const howManyOldCars = oldCars.length;
console.log(howManyOldCars);
